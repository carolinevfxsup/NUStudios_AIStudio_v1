...
export const ResultsPageBento = () => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-1">
      ...
      {/* Project 2 (Square) */}
      <Link to={showcases[1].slug} className={`relative md:col-span-4 aspect-square ${bgColor} flex flex-col items-center justify-center`}>
        <div className="relative w-full h-full md:w-[75%] md:h-[75%] overflow-hidden rounded-md">
          <video 
      ...
      {/* Project 4 (Wide) */}
      <Link to={showcases[3].slug} className={`relative md:col-span-8 aspect-video ${bgColor} flex flex-col items-center justify-center`}>
        <div className="relative w-full h-full md:w-[75%] md:h-[75%] overflow-hidden rounded-md">
          <video 
